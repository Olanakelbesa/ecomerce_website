            ...
            {isAuthenticated ? (
              <div className="space-y-4">
                ...
                <div className="pt-3 border-t border-border space-y-3">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="w-full text-left text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors font-medium py-2 px-3 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center"
                  >
                    <LogOut className="h-4 w-4 mr-3" />
                    Sign Out
                  </button>
